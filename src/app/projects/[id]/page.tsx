...
import { WORKS } from "@/app/data/projects";
import { useParams } from "next/navigation";
import React, { useEffect, useRef } from "react";
import gsap from "gsap";
import { ScrollTrigger } from "gsap/ScrollTrigger";
import CustomCursorWrapper from "@/app/components/CustomCursor";
    ...
    <div>
      ...
      >
        ...
        <img
          ...
          alt="..."
          ref={imgRef}
          className="md:h-[76vh] md:w-[50vw] w-[90vw] object-cover center object-top "
        />
      </div>
