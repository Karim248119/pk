...
const Projects = () => {
  ...
  const getProjectClasses = (idx: number) => {
    ...
    return [
      ...
      isNeighbor && "opacity-25 hover:opacity-75 duration-500 cursor-pointer",
      selectedIndex &&
        selectedIndex + 1 === idx &&
  ...
  return (
    ...
    >
      ...
      {selectedProject && (
        <div
          key={selectedIndex}
          className="absolute left-0 bottom-0 md:px-20 px-5 py-10 z-50 w-full grid md:grid-cols-3 md:grid-rows-1 grid-rows-3 gap-3 items-end md:items-start"
        >
          <Typo
            base
            hidden
          ...
          <div className="justify-self-end space-y-1 uppercase font-semibold md:text-sm text-xs">
